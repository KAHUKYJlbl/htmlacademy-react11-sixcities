...
export const offerToAdd: Offer = {
  ...
  isPremium: false,
  location: {
    latitude: 48.85790117000979,
    longitude: 2.314240406108316,
    zoom: 8
  },
  maxAdults: 7,
...
export const offerToRemove: Offer = {
  bedrooms: 7,
  city: {
    location: {
      latitude: 48.857901,
...
export const favoritesToRemove: Offer[] = [
  {
    bedrooms: 1,
    city: {
      location: {
  ...
  },
  {
    ...
    isPremium: true,
    location: {
      latitude: 53.55743868460439,
      longitude: 9.992444481846945,
      zoom: 8
    },
    maxAdults: 5,
    previewImage: 'img/apartment-03.jpg',
...
export const favoritesToAdd: Offer[] = [
  {
    bedrooms: 1,
    city: {
      location: {
